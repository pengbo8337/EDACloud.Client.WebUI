<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="package_code" label="套餐代码" align="center"></el-table-column>
      <el-table-column prop="package_name" label="套餐名称" align="center"></el-table-column>
      <el-table-column prop="package_describe" label="套餐描述" align="center"></el-table-column>
      <el-table-column prop="imageId" label="镜像ID" align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    confirmPay() {
      ...
      this.$ajaxs
        .confirmConsume({ orderid: this.orderId, eda: this.currentMoney },this.orderId)
        .then(
          res => {
            if (res.statusCode == 0) {
              this.$message({
